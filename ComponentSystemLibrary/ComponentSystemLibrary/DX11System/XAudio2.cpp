...
{
	{"assets/Sound/BGM/sample001.wav", true},	// サンプルBGM（ループさせるのでtrue設定）
	{"assets/Sound/SE/Bullet_trance.wav",false},		// サンプルSE（ループしないのでfalse設定） 0
};
...
//=============================================================================
// 再生状態の取得	（ 再生中なら[true]、停止中なら[false]を返す ）
//=============================================================================
