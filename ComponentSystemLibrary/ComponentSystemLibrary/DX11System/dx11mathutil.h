...
void DX11MakeWorldMatrix(XMFLOAT4X4& mat, XMFLOAT3& scale, XMFLOAT3& angle, XMFLOAT3& trans);
void DX11MakeWorldMatrix(XMFLOAT4X4& mat, Vector3& scale, Vector3& angle, Vector3& trans);
